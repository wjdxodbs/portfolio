...
export const skills: Skill[] = [
  {
    ...
    level: 4,
    capabilities: [
      "컴포넌트 기반 아키텍처에 대한 이해를 바탕으로, 재사용성과 유지보수성을 고려한 UI 컴포넌트를 설계하고 구현할 수 있습니다.",
      "React Router를 활용해 다중 페이지 애플리케이션을 구성할 수 있으며, 동적 라우팅 및 중첩 라우팅 등 다양한 라우팅 패턴을 활용할 수 있습니다.",
      "메모이제이션과 코드 스플리팅 기법을 통해 애플리케이션의 성능 최적화를 적용할 수 있습니다. ",
    ],
  },
  {
    name: "Next.js",
