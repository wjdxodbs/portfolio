...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      "Route Handler를 활용해 외부 API 키를 서버에서 관리하는 프록시 패턴을 구현할 수 있다.",
    ],
  },
  {
    name: "TypeScript",
    ...
    capabilities: [
      ...
      "keyof typeof, Pick, Omit 등 유틸리티 타입을 활용해 상수 객체에서 타입을 파생하고 중복을 줄일 수 있다.",
    ],
  },
  {
    name: "JavaScript",
  ...
  },
  {
    ...
    capabilities: [
      ...
      "서버에서 데이터를 프리페칭하고 클라이언트에 하이드레이션하여 초기 로딩 성능을 최적화할 수 있다.",
    ],
  },
  {
    name: "SCSS",
  ...
  },
  {
    ...
    capabilities: [
      ...
      "CSS 변수를 활용한 테마 시스템 구축을 통해 일관된 디자인을 구현할 수 있다.",
    ],
  },
  {
    name: "shadcn/ui",
    ...
    capabilities: [
      ...
      "Tailwind CSS와 결합하여 일관된 디자인 토큰 기반의 UI를 구축할 수 있다.",
    ],
  },
  {
    name: "HTML",
    ...
    capabilities: [
      ...
      "WAI-ARIA 속성을 활용해 모달, 아코디언 등 인터랙티브 요소의 접근성을 구현할 수 있다.",
    ],
  },
  {
    name: "CSS",
